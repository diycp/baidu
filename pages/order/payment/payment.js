...
var bdpay = function () {
    ...
    util.wxRequest({
        ...
        success: function (res) {
            swan.hideToast()
            console.log('dopayment back res');
            console.log(res);
            if (res.data.error) {
                swan.showModal({
                    title: '支付请求异常',
                ...
                pay_params.fail = function (err) {
                    console.log('pay fail', err);
                    // swan.showToast({
                    //     title: JSON.stringify(err)
                    // });
                    if (res.errMsg == 'requestPolymerPayment:fail cancel') {
                        return;
                    }
                }
                console.log(pay_params);
                swan.requestPolymerPayment(pay_params);
            }
        }
    });
