...
Page({
    ...
    onLoad: function(options) {
        ...
        util.wxRequest({
            ...
            success: function(res) {
                ...
                app.oceanWay('ViewProduct', {
                  ...
                  ProductCatalog: pagedata.data_detail.category&&pagedata.data_detail.category.cat_name,
                  ProductUnit: pagedata.data_detail.product.unit,
                  ProductName: pagedata.data_detail.product.name,
                  ProductBrand: pagedata.data_detail.brand&&pagedata.data_detail.brand.brand_name,
        ...
        let merchant_id = swan.getStorageSync('merchant_id') ? swan.getStorageSync('merchant_id') : 'true';
        this.setData({
                        ...
                        util.wxRequest({
                            ...
                            success: function(res) {
                                ...
                                util.getqrcode({
                                    ...
                                    var padding = 10;
                                    var h_fontsize = 16;
                                    var ctx = swan.createCanvasContext('poster_canvas');
                                    swan.getImageInfo({
                                        src: big_img_url,
