    ...
    omnipotentform: {
        ...
        event: {
            onLoad: function(widget_data, index) {
                ...
                util.wxRequest({
                    ...
                    success: function(res) {
                        ...
                        form['widgets.omnipotentform.' + index + '.imgcode'] = config.BASE_URL + '/vcode-index-universalform.html?sess_id=' + swan.getStorageSync('_SID');
                        _this.setData(form);
            ...
            evt_getimagecode: function(e) {
                ...
                var img_url = config.BASE_URL + '/vcode-index-universalform.html?' + new Date().getTime() + '&sess_id=' + swan.getStorageSync('_SID');
                this.setData({
                    [skey]: img_url,
                })
            }
    ...
    labelnav: {
        ...
        event: {
            ...
            evt_tabscroll: function(e) {
                swan.setStorageSync('scrollLeft', e.detail.scrollLeft);
            },
            evt_openPage: function(e) {
                //点击跳转事件
                var dataset = e.currentTarget.dataset;
                var scrollLeft = swan.getStorageSync('scrollLeft');
                var _this = this;
                var url = dataset.url,
